...
#ifndef LIB_ADAFRUIT_AS276XSOFT
#define LIB_ADAFRUIT_AS276XSOFT
...
*/
/**************************************************************************/
class Adafruit_AS726xSoft {
	public:
		/*! 
		    @brief  Class constructor
		    @param addr Optional I2C address the sensor can be found on. Defaults to 0x49.
		*/
		Adafruit_AS726xSoft(int8_t addr = AS726x_ADDRESS) { _i2caddr = addr; };
		~Adafruit_AS726xSoft(void) {};
		
		bool begin(SoftWire *theWire);
