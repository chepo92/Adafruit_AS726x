...
/*! 
    ...
    @param theWire a SoftWire object to use for I2C communication
    @return true on success, fale otherwise.
*/
/**************************************************************************/
bool Adafruit_AS726xSoft::begin(SoftWire *theWire)
{
	_i2c = theWire;
	_i2c_init();
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::drvOn()
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::drvOff()
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::setDrvCurrent(uint8_t current)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::indicateLED(boolean on)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::setIndicateCurrent(uint8_t current)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::setConversionType(uint8_t type)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::setGain(uint8_t gain)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::setIntegrationTime(uint8_t time)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::enableInterrupt()
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::disableInterrupt()
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::startMeasurement()
{
...
*/
/**************************************************************************/
uint16_t Adafruit_AS726xSoft::readChannel(uint8_t channel)
{
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::readRawValues(uint16_t *buf, uint8_t num)
{
	for(int i = 0; i < num; i++){
		switch(i){
			case AS726x_VIOLET:
...
*/
/**************************************************************************/
void Adafruit_AS726xSoft::readCalibratedValues(float *buf, uint8_t num){
	for(int i = 0; i < num; i++){
		switch(i){
			case AS726x_VIOLET:
...
*/
/**************************************************************************/
float Adafruit_AS726xSoft::readCalibratedValue(uint8_t channel)
{
	uint32_t val = 0;
...
void Adafruit_AS726xSoft::write8(byte reg, byte value)
{
	this->write(reg, &value, 1);
}

uint8_t Adafruit_AS726xSoft::read8(byte reg)
{
	uint8_t ret;
	this->read(reg, &ret, 1);
...
uint8_t Adafruit_AS726xSoft::virtualRead(uint8_t addr)
{
...
void Adafruit_AS726xSoft::virtualWrite(uint8_t addr, uint8_t value)
{
...
void Adafruit_AS726xSoft::read(uint8_t reg, uint8_t *buf, uint8_t num)
{
	uint8_t value;
	uint8_t pos = 0;
...
void Adafruit_AS726xSoft::write(uint8_t reg, uint8_t *buf, uint8_t num)
{
	_i2c->beginTransmission((uint8_t)_i2caddr);
...
void Adafruit_AS726xSoft::_i2c_init()
{
	_i2c->begin();
}
